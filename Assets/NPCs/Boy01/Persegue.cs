...
namespace SG
{
    public class Persegue : MonoBehaviour
    {
        ...
        // Adicionando uma variável para a distância de parada
        ...
        void Start()
        {
            ...
            // Define a distância de parada do NavMeshAgent
        ...
        void Hide()
        {
            ...
            Seek(chosenSpot);
            isHiding = true; // Indica que o NPC está se escondendo
        }
        ...
        {
            coolDown = false;
            isHiding = false; // Reinicia o indicador de se está se escondendo
        }
