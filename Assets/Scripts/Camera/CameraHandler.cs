...
namespace SG
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            inputHandler = Object.FindFirstObjectByType<InputHandler>();
        ...
        public void HandleLockOn()
        {
            ...
            for (int k = 0; k < availableTargets.Count; k++)
            {
                ...
                if(inputHandler.lockOnFlag)
                {
                    ...
                    else if (relativeEnemyPosition.x >= 0.00 && Mathf.Abs(distanceFromRightTarget) < shortestDistanceOfRightTarget
                        && availableTargets[k] != currentLockOnTarget)
                    {
